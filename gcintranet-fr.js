...
wet.builder.environment = function(opt_data, opt_ignored) {
  return (opt_data.cdnEnv == 'qat' || opt_data.cdnEnv == 'nonprod' || opt_data.cdnEnv == 'esdcprod') ? '/cdn/' : (opt_data.cdnPath != null) ? soy.$$escapeHtml(opt_data.cdnPath) : '/cdts/';
};
