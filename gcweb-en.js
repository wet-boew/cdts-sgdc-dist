  ...
  if (opt_data.breadcrumbs != false) {
    ...
    if (opt_data.breadcrumbs != null) {
      ...
      for (var itemIndex80 = 0; itemIndex80 < itemListLen80; itemIndex80++) {
        ...
        output += '<li>' + ((itemData80.acronym != null) ? '<abbr title="' + soy.$$escapeHtml(itemData80.acronym) + '">' : '') + ((itemData80.href != null) ? '<a href="' + soy.$$escapeHtml(itemData80.href) + '">' : '') + soy.$$escapeHtml(itemData80.title) + ((itemData80.href != null) ? '</a>' : '') + ((itemData80.acronym != null) ? '</abbr>' : '') + '</li>';
      }
    } else {
  ...
  for (var sectionIndex196 = 0; sectionIndex196 < sectionListLen196; sectionIndex196++) {
    ...
    for (var linkIndex215 = 0; linkIndex215 < linkListLen215; linkIndex215++) {
      ...
      if (linkData215.subLinks != null) {
        output += '<li><a href="' + soy.$$escapeHtml(linkData215.href) + '" class="list-group-item"' + ((linkData215.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData215.text) + ((linkData215.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a><ul class="list-group menu list-unstyled">';
        ...
        for (var sublinkIndex230 = 0; sublinkIndex230 < sublinkListLen230; sublinkIndex230++) {
          ...
          output += '<li><a href="' + soy.$$escapeHtml(sublinkData230.subhref) + '" class="list-group-item"' + ((sublinkData230.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(sublinkData230.subtext) + ((sublinkData230.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
        }
        output += '</ul></li>';
      } else {
        output += '<li><a href="' + soy.$$escapeHtml(linkData215.href) + '" class="list-group-item"' + ((linkData215.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData215.text) + ((linkData215.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
      }
    }
    output += '</ul></section>';
  }
  ...
  if (opt_data.showFooter != false) {
    ...
    if (opt_data.contactLinks != null) {
      ...
      for (var linkIndex268 = 0; linkIndex268 < linkListLen268; linkIndex268++) {
        ...
        output += (linkIndex268 == 0) ? '<li><a href="' + soy.$$escapeHtml(linkData268.href) + '">Contact us</a></li>' : '';
      }
    } else {
    ...
    if (opt_data.contactLinks != null) {
      ...
      for (var linkIndex282 = 0; linkIndex282 < linkListLen282; linkIndex282++) {
        ...
        output += (linkIndex282 == 0) ? '<li><a ' + ((linkData282.href) ? ' href="' + soy.$$escapeHtml(linkData282.href) + '"' : ' href="https://www.canada.ca/en/contact.html"') + ((linkData282.newWindow) ? ' target="_blank"  rel="noopener"' : '') + '>Contact information' + ((linkData282.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '';
      }
    } else {
    ...
    if (opt_data.termsLink != null) {
      ...
      for (var linkIndex306 = 0; linkIndex306 < linkListLen306; linkIndex306++) {
        ...
        output += (linkIndex306 == 0) ? '<li><a ' + ((linkData306.href) ? ' href="' + soy.$$escapeHtml(linkData306.href) + '"' : ' href="https://www.canada.ca/en/transparency/terms.html"') + ((linkData306.newWindow) ? ' target="_blank"  rel="noopener"' : '') + '>Terms and conditions' + ((linkData306.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '';
      }
    } else {
    ...
    if (opt_data.privacyLink != null) {
      ...
      for (var linkIndex330 = 0; linkIndex330 < linkListLen330; linkIndex330++) {
        ...
        output += (linkIndex330 == 0) ? '<li><a ' + ((linkData330.href) ? ' href="' + soy.$$escapeHtml(linkData330.href) + '"' : ' href="https://www.canada.ca/en/transparency/privacy.html"') + ((linkData330.newWindow) ? ' target="_blank"  rel="noopener"' : '') + '>Privacy' + ((linkData330.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '';
      }
    } else {
...
wet.builder.splash = function(opt_data, opt_ignored) {
  ...
  var lang__soy415 = navigator.language;
  output += '<ul class="list-inline lst-spcd"><li>' + ((lang__soy415 == 'en-CA') ? '<a href="' + soy.$$escapeHtml(opt_data.indexEng) + '" class="btn btn-primary" lang="en">English</a>' : '<a href="' + soy.$$escapeHtml(opt_data.indexEng) + '" class="btn btn-default" lang="en">English</a>') + '</li><li>' + ((lang__soy415 == 'fr-CA') ? '<a href="' + soy.$$escapeHtml(opt_data.indexFra) + '" class="btn btn-primary" lang="fr">Français</a>' : '<a href="' + soy.$$escapeHtml(opt_data.indexFra) + '" class="btn btn-default" lang="fr">Français</a>') + '</li></ul></row></div><div class="sp-bx-bt col-xs-12"><div class="row"><div class="col-xs-7 col-md-8"><a href="' + soy.$$escapeHtml(opt_data.termsEng) + '" class="sp-lk">Terms & conditions</a> <span class="glyphicon glyphicon-asterisk"></span> <a href="' + soy.$$escapeHtml(opt_data.termsFra) + '" class="sp-lk" lang="fr">Avis</a></div><div class="col-xs-5 col-md-4 text-right mrgn-bttm-md"><img src=\'./gcweb/assets/wmms-spl.svg\' width="127" alt="Symbol of the Government of Canada / Symbole du gouvernement du Canada" /></div></div></div></div></main><!--[if gte IE 9 | !IE ]><!--><script src="' + ((opt_data.jqueryEnv == 'external') ? 'https://ajax.googleapis.com/ajax/libs' : './wet-boew/js/') + 'jquery/2.2.4/jquery.min.js"><\/script><script src=\'./wet-boew/js/wet-boew.min.js\'><\/script><!--<![endif]--><!--[if lt IE 9]><script src=\'./wet-boew/js/ie8-wet-boew2.min.js\'><\/script><![endif]--><script src=\'./gcweb/js/theme.min.js\'><\/script>' + ((opt_data.webAnalytics != null) ? '<script>_satellite.pageBottom();<\/script>' : '') + '<link rel="stylesheet" href=\'./cdts/css/cdtsfixes.css\'>';
  return output;
};
...
applicationPage.appTop = function(opt_data, opt_ignored) {
  ...
  if (opt_data.customSearch != null) {
    ...
    for (var itemIndex30 = 0; itemIndex30 < itemListLen30; itemIndex30++) {
      ...
      if (itemIndex30 == 0) {
        output += '<section id="wb-srch" class="col-lg-8 text-right visible-md visible-lg"><h2>Search' + ((itemData30.placeholder != null) ? ' ' + soy.$$escapeHtml(itemData30.placeholder) : '') + '</h2><form action="' + soy.$$escapeHtml(itemData30.action) + '" method="' + soy.$$escapeHtml(itemData30.method) + '" name="cse-search-box" role="search" class="form-inline"><div class="form-group"><label for="' + ((itemData30.id != null) ? soy.$$escapeHtml(itemData30.id) : 'wb-srch-q') + '" class="wb-inv">Search' + ((itemData30.placeholder != null) ? ' ' + soy.$$escapeHtml(itemData30.placeholder) : '') + '</label><input id="' + ((itemData30.id != null) ? soy.$$escapeHtml(itemData30.id) : 'wb-srch-q') + '" class="wb-srch-q form-control" name="q" type="search" value="" size="34" maxlength="170" placeholder="Search' + ((itemData30.placeholder != null) ? ' ' + soy.$$escapeHtml(itemData30.placeholder) : '') + '">';
        ...
        output += '</div><div class="form-group submit"><button type="submit" id="wb-srch-sub" class="btn btn-primary btn-small" name="wb-srch-sub"><span class="glyphicon-search glyphicon"></span><span class="wb-inv">Search' + ((itemData30.placeholder != null) ? ' ' + soy.$$escapeHtml(itemData30.placeholder) : '') + '</span></button></div></form></section>';
      }
    }
  }
  ...
  for (var itemIndex87 = 0; itemIndex87 < itemListLen87; itemIndex87++) {
    ...
    output += (itemIndex87 == 0) ? '<h2 class="wb-inv">Name of Web application</h2><a class="app-name" href="' + soy.$$escapeHtml(itemData87.href) + '">' + soy.$$escapeHtml(itemData87.text) + '</a>' : '';
  }
  output += '</section>';
  if (opt_data.appSettings != null || opt_data.signOut != null || opt_data.signIn != null) {
    ...
    if (opt_data.appSettings != null) {
      ...
      for (var itemIndex102 = 0; itemIndex102 < itemListLen102; itemIndex102++) {
        ...
        output += (itemIndex102 == 0) ? '<li><a href="' + soy.$$escapeHtml(itemData102.href) + '" class="btn"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Account settings</a></li>&#32;' : '';
      }
    }
    if (opt_data.signOut != null) {
      ...
      for (var itemIndex111 = 0; itemIndex111 < itemListLen111; itemIndex111++) {
        ...
        output += (itemIndex111 == 0) ? '<li><a href="' + soy.$$escapeHtml(itemData111.href) + '" class="btn"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Sign out</a></li>' : '';
      }
      ...
      for (var itemIndex119 = 0; itemIndex119 < itemListLen119; itemIndex119++) {
        ...
        output += (itemIndex119 == 0) ? '<li><a href="' + soy.$$escapeHtml(itemData119.href) + '" class="btn"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Sign in</a></li>' : '';
      }
    }
    output += '</ul></nav>';
  }
    ...
    if (opt_data.menuPath != null || opt_data.menuLinks != null || opt_data.topSecMenu == true || opt_data.customSearch != null) {
      ...
      if (opt_data.customSearch != null) {
        ...
        for (var itemIndex152 = 0; itemIndex152 < itemListLen152; itemIndex152++) {
          ...
          if (itemIndex152 == 0) {
            output += '<section id="app-srch-mb" class="wb-overlay modal-content overlay-def wb-bar-t"><div class="modal-header"><h3 class="modal-title">Search' + ((itemData152.placeholder != null) ? ' ' + soy.$$escapeHtml(itemData152.placeholder) : '') + '</h3></div><div class="modal-body"><form action="' + soy.$$escapeHtml(itemData152.action) + '" method="' + soy.$$escapeHtml(itemData152.method) + '" name="cse-search-box" role="search" class="form-inline"><div class="input-group"><label for="' + ((itemData152.id != null) ? 'app-' + soy.$$escapeHtml(itemData152.id) : 'app-srch-q-mb') + '" class="wb-inv">Search' + ((itemData152.placeholder != null) ? ' ' + soy.$$escapeHtml(itemData152.placeholder) : '') + '</label><input placeholder="Search' + ((itemData152.placeholder != null) ? ' ' + soy.$$escapeHtml(itemData152.placeholder) : '') + '" id="' + ((itemData152.id != null) ? 'app-' + soy.$$escapeHtml(itemData152.id) : 'app-srch-q-mb') + '" class="app-srch-q-mb form-control" name="q" type="search" value="" size="27" maxlength="150">';
            ...
            output += '<span class="input-group-btn"><button type="submit" id="app-srch-sub-mb" class="btn btn-primary btn-small" name="app-srch-sub-mb"><span class="glyphicon-search glyphicon"></span><span class="wb-inv">Search' + ((itemData152.placeholder != null) ? ' ' + soy.$$escapeHtml(itemData152.placeholder) : '') + '</span></button></span></div></form></div></section>';
          }
        }
      }
      output += '</nav>';
    ...
    if (opt_data.appSettings != null || opt_data.signOut != null || opt_data.signIn != null) {
      ...
      if (opt_data.appSettings != null) {
        ...
        for (var itemIndex211 = 0; itemIndex211 < itemListLen211; itemIndex211++) {
          ...
          output += (itemIndex211 == 0) ? '<li><a href="' + soy.$$escapeHtml(itemData211.href) + '" class="btn"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Account settings</a></li>&#32;' : '';
        }
      }
      if (opt_data.signOut != null) {
        ...
        for (var itemIndex220 = 0; itemIndex220 < itemListLen220; itemIndex220++) {
          ...
          output += (itemIndex220 == 0) ? '<li><a href="' + soy.$$escapeHtml(itemData220.href) + '" class="btn"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Sign out</a></li>' : '';
        }
      } else if (opt_data.signIn != null) {
        ...
        for (var itemIndex228 = 0; itemIndex228 < itemListLen228; itemIndex228++) {
          ...
          output += (itemIndex228 == 0) ? '<li><a href="' + soy.$$escapeHtml(itemData228.href) + '" class="btn"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Sign in</a></li>' : '';
        }
      }
      output += '</ul></nav>';
    }
    ...
    if (opt_data.menuLinks != null) {
      ...
      for (var linkIndex240 = 0; linkIndex240 < linkListLen240; linkIndex240++) {
        ...
        if (linkData240.subLinks != null) {
          output += '<li><a href="#' + soy.$$escapeHtml(linkData240.id) + '" class="item"' + ((linkData240.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData240.text) + ((linkData240.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a><ul class="sm list-unstyled" id="' + soy.$$escapeHtml(linkData240.id) + '" role="menu">';
          ...
          for (var sublinkIndex257 = 0; sublinkIndex257 < sublinkListLen257; sublinkIndex257++) {
            ...
            output += (sublinkIndex257 == sublinkListLen257 - 1) ? '<li class="slflnk"><a href="' + soy.$$escapeHtml(sublinkData257.subhref) + '"' + ((sublinkData257.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(sublinkData257.subtext) + ((sublinkData257.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '<li><a href="' + soy.$$escapeHtml(sublinkData257.subhref) + '"' + ((sublinkData257.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(sublinkData257.subtext) + ((sublinkData257.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
          }
          output += '</ul></li>';
        } else {
          output += '<li><a href="' + soy.$$escapeHtml(linkData240.href) + '" class="item"' + ((linkData240.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData240.text) + ((linkData240.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
        }
      }
...
applicationPage.appFooter = function(opt_data, opt_ignored) {
  ...
  if (opt_data.footerSections != null) {
    ...
    for (var linkIndex339 = 0; linkIndex339 < linkListLen339; linkIndex339++) {
      ...
      output += '<li><a href="' + soy.$$escapeHtml(linkData339.href) + '"' + ((linkData339.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData339.text) + ((linkData339.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
    }
    output += '</ul></nav></div>';
  }
  ...
  if (opt_data.contactLink != null) {
    ...
    for (var linkIndex357 = 0; linkIndex357 < linkListLen357; linkIndex357++) {
      ...
      output += (linkIndex357 == 0) ? '<li><a ' + ((linkData357.href) ? ' href="' + soy.$$escapeHtml(linkData357.href) + '"' : ' href="https://www.canada.ca/en/contact.html"') + ((linkData357.newWindow) ? ' target="_blank"  rel="noopener"' : '') + '>Contact information' + ((linkData357.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '';
    }
  } else {
    output += '<li><a href="https://www.canada.ca/en/contact.html">Contact information</a></li>';
  }
  if (opt_data.termsLink != null) {
    ...
    for (var linkIndex381 = 0; linkIndex381 < linkListLen381; linkIndex381++) {
      ...
      output += (linkIndex381 == 0) ? '<li><a ' + ((linkData381.href) ? ' href="' + soy.$$escapeHtml(linkData381.href) + '"' : ' href="https://www.canada.ca/en/transparency/terms.html"') + ((linkData381.newWindow) ? ' target="_blank"  rel="noopener"' : '') + '>Terms and conditions' + ((linkData381.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '';
    }
  } else {
    output += '<li><a href="https://www.canada.ca/en/transparency/terms.html">Terms and conditions</a></li>';
  }
  if (opt_data.privacyLink != null) {
    ...
    for (var linkIndex405 = 0; linkIndex405 < linkListLen405; linkIndex405++) {
      ...
      output += (linkIndex405 == 0) ? '<li><a ' + ((linkData405.href) ? ' href="' + soy.$$escapeHtml(linkData405.href) + '"' : ' href="https://www.canada.ca/en/transparency/privacy.html"') + ((linkData405.newWindow) ? ' target="_blank"  rel="noopener"' : '') + '>Privacy' + ((linkData405.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '';
    }
  } else {
    output += '<li><a href="https://www.canada.ca/en/transparency/privacy.html">Privacy</a></li>';
  }
