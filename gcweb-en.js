  ...
  if (opt_data.breadcrumbs != false) {
    ...
    if (opt_data.breadcrumbs != null) {
      ...
      for (var itemIndex100 = 0; itemIndex100 < itemListLen100; itemIndex100++) {
        ...
        output += '<li>' + ((itemData100.acronym != null) ? '<abbr title="' + soy.$$escapeHtml(itemData100.acronym) + '">' : '') + ((itemData100.href != null) ? '<a href="' + soy.$$escapeHtml(itemData100.href) + '">' : '') + soy.$$escapeHtml(itemData100.title) + ((itemData100.href != null) ? '</a>' : '') + ((itemData100.acronym != null) ? '</abbr>' : '') + '</li>';
      }
    } else {
...
wet.builder.secmenu = function(opt_data, opt_ignored) {
  ...
  for (var sectionIndex216 = 0; sectionIndex216 < sectionListLen216; sectionIndex216++) {
    ...
    output += '<section class="list-group menu list-unstyled"><h3>' + ((sectionData216.sectionLink != null) ? '<a href="' + soy.$$escapeHtml(sectionData216.sectionLink) + '"' + ((sectionData216.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' : '') + soy.$$escapeHtml(sectionData216.sectionName) + ((sectionData216.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + ((sectionData216.sectionLink != null) ? '</a>' : '') + '</h3><ul class="list-group menu list-unstyled">';
    ...
    for (var linkIndex235 = 0; linkIndex235 < linkListLen235; linkIndex235++) {
      ...
      if (linkData235.subLinks != null) {
        output += '<li><a href="' + soy.$$escapeHtml(linkData235.href) + '" class="list-group-item"' + ((linkData235.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData235.text) + ((linkData235.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a><ul class="list-group menu list-unstyled">';
        ...
        for (var sublinkIndex250 = 0; sublinkIndex250 < sublinkListLen250; sublinkIndex250++) {
          ...
          output += '<li><a href="' + soy.$$escapeHtml(sublinkData250.subhref) + '" class="list-group-item"' + ((sublinkData250.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(sublinkData250.subtext) + ((sublinkData250.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
        }
        output += '</ul></li>';
      } else {
        output += '<li><a href="' + soy.$$escapeHtml(linkData235.href) + '" class="list-group-item"' + ((linkData235.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData235.text) + ((linkData235.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
      }
    }
    output += '</ul></section>';
  }
  ...
  if (opt_data.showFooter != false) {
    ...
    if (opt_data.contactLinks != null) {
      ...
      for (var linkIndex288 = 0; linkIndex288 < linkListLen288; linkIndex288++) {
        ...
        output += (linkIndex288 == 0) ? '<li><a href="' + soy.$$escapeHtml(linkData288.href) + '">Contact us</a></li>' : '';
      }
    } else {
    ...
    if (opt_data.contactLinks != null) {
      ...
      for (var linkIndex302 = 0; linkIndex302 < linkListLen302; linkIndex302++) {
        ...
        output += (linkIndex302 == 0) ? '<li><a ' + ((linkData302.href) ? ' href="' + soy.$$escapeHtml(linkData302.href) + '"' : ' href="https://www.canada.ca/en/contact.html"') + ((linkData302.newWindow) ? ' target="_blank"  rel="noopener"' : '') + '>Contact information' + ((linkData302.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '';
      }
    } else {
    ...
    if (opt_data.termsLink != null) {
      ...
      for (var linkIndex326 = 0; linkIndex326 < linkListLen326; linkIndex326++) {
        ...
        output += (linkIndex326 == 0) ? '<li><a ' + ((linkData326.href) ? ' href="' + soy.$$escapeHtml(linkData326.href) + '"' : ' href="https://www.canada.ca/en/transparency/terms.html"') + ((linkData326.newWindow) ? ' target="_blank"  rel="noopener"' : '') + '>Terms and conditions' + ((linkData326.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '';
      }
    } else {
    ...
    if (opt_data.privacyLink != null) {
      ...
      for (var linkIndex350 = 0; linkIndex350 < linkListLen350; linkIndex350++) {
        ...
        output += (linkIndex350 == 0) ? '<li><a ' + ((linkData350.href) ? ' href="' + soy.$$escapeHtml(linkData350.href) + '"' : ' href="https://www.canada.ca/en/transparency/privacy.html"') + ((linkData350.newWindow) ? ' target="_blank"  rel="noopener"' : '') + '>Privacy' + ((linkData350.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '';
      }
    } else {
...
wet.builder.splash = function(opt_data, opt_ignored) {
  ...
  var lang__soy466 = navigator.language;
  output += '<ul class="list-inline lst-spcd"><li>' + ((lang__soy466 == 'en-CA') ? '<a href="' + soy.$$escapeHtml(opt_data.indexEng) + '" class="btn btn-primary" lang="en">English</a>' : '<a href="' + soy.$$escapeHtml(opt_data.indexEng) + '" class="btn btn-default" lang="en">English</a>') + '</li><li>' + ((lang__soy466 == 'fr-CA') ? '<a href="' + soy.$$escapeHtml(opt_data.indexFra) + '" class="btn btn-primary" lang="fr">Français</a>' : '<a href="' + soy.$$escapeHtml(opt_data.indexFra) + '" class="btn btn-default" lang="fr">Français</a>') + '</li></ul></row></div><div class="sp-bx-bt col-xs-12"><div class="row"><div class="col-xs-7 col-md-8"><a href="' + soy.$$escapeHtml(opt_data.termsEng) + '" class="sp-lk">Terms & conditions</a> <span class="glyphicon glyphicon-asterisk"></span> <a href="' + soy.$$escapeHtml(opt_data.termsFra) + '" class="sp-lk" lang="fr">Avis</a></div><div class="col-xs-5 col-md-4 text-right mrgn-bttm-md"><img src=\'' + wet.builder.environment(opt_data) + 'gcweb/assets/wmms-spl.svg\' width="127" alt="Symbol of the Government of Canada / Symbole du gouvernement du Canada" /></div></div></div></div></main><!--[if gte IE 9 | !IE ]><!--><script src="' + ((opt_data.jqueryEnv == 'external') ? 'https://ajax.googleapis.com/ajax/libs' : wet.builder.environment(opt_data) + 'wet-boew/js/') + 'jquery/2.2.4/jquery.min.js"><\/script><script src=\'' + wet.builder.environment(opt_data) + 'wet-boew/js/wet-boew.min.js\'><\/script><!--<![endif]--><!--[if lt IE 9]><script src=\'' + wet.builder.environment(opt_data) + 'wet-boew/js/ie8-wet-boew2.min.js\'><\/script><![endif]--><script src=\'' + wet.builder.environment(opt_data) + 'gcweb/js/theme.min.js\'><\/script>' + ((opt_data.webAnalytics != null) ? '<script>_satellite.pageBottom();<\/script>' : '') + '<link rel="stylesheet" href=\'' + wet.builder.environment(opt_data) + 'cdts/css/cdtsfixes.css\'>';
  return output;
};
