...
wet.builder.appTop = function(opt_data, opt_ignored) {
  ...
  if (opt_data.search != false) {
    ...
    if (opt_data.customSearch != null) {
      ...
      for (var itemIndex380 = 0; itemIndex380 < itemListLen380; itemIndex380++) {
        ...
        if (itemIndex380 == 0) {
          output += '<form action="' + ((itemData380.action != null) ? soy.$$escapeHtml(itemData380.action) : 'https://intranet.canada.ca/search-recherche/query-recherche-eng.aspx') + '" method="' + ((itemData380.method != null) ? soy.$$escapeHtml(itemData380.method) : 'get') + '" name="' + ((itemData380.name != null) ? soy.$$escapeHtml(itemData380.name) : 'cse-search-box') + '" role="search" class="form-inline"><div class="form-group"><label for="' + ((itemData380.id != null) ? soy.$$escapeHtml(itemData380.id) : 'wb-srch-q') + '" class="wb-inv">' + ((itemData380.placeholder != null) ? soy.$$escapeHtml(itemData380.placeholder) : 'Search GCintranet') + '</label><input class="wb-srch-q form-control pull-right" id="' + ((itemData380.id != null) ? soy.$$escapeHtml(itemData380.id) : 'wb-srch-q') + '" name="' + ((itemData380.name != null) ? soy.$$escapeHtml(itemData380.name) : 'q') + '"  value="' + ((itemData380.value != null) ? soy.$$escapeHtml(itemData380.value) : '') + '" size="21" maxlength="150" placeholder="' + ((itemData380.placeholder != null) ? soy.$$escapeHtml(itemData380.placeholder) : 'Search GCintranet') + '">';
  ...
  if (opt_data.signOut != null) {
    ...
    for (var buttonIndex546 = 0; buttonIndex546 < buttonListLen546; buttonIndex546++) {
      ...
      output += (buttonIndex546 == 0) ? '<p><a href="' + soy.$$escapeHtml(buttonData546.href) + '" class="btn btn-default btn btn-signoff"><i class="glyphicon glyphicon-off mrgn-rght-md"></i>Sign out</a></p>' : '';
    }
    output += '</div></div>';
    ...
    for (var buttonIndex556 = 0; buttonIndex556 < buttonListLen556; buttonIndex556++) {
      ...
      output += (buttonIndex556 == 0) ? '<p><a href="' + soy.$$escapeHtml(buttonData556.href) + '" class="btn btn-default btn btn-signoff"><i class="glyphicon glyphicon-off mrgn-rght-md"></i>Sign in</a></p>' : '';
    }
    output += '</div></div>';
  } else {
  }
  ...
  if (opt_data.menuLinks != null) {
    ...
    for (var linkIndex569 = 0; linkIndex569 < linkListLen569; linkIndex569++) {
      ...
      if (linkData569.subLinks != null) {
        output += '<li><a href="#' + soy.$$escapeHtml(linkData569.id) + '" class="item"' + ((linkData569.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData569.text) + ((linkData569.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a><ul class="sm list-unstyled" id="' + soy.$$escapeHtml(linkData569.id) + '" role="menu">';
        ...
        for (var sublinkIndex586 = 0; sublinkIndex586 < sublinkListLen586; sublinkIndex586++) {
          ...
          output += (sublinkIndex586 == sublinkListLen586 - 1) ? '<li class="slflnk"><a href="' + soy.$$escapeHtml(sublinkData586.subhref) + '"' + ((sublinkData586.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(sublinkData586.subtext) + ((sublinkData586.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '<li><a href="' + soy.$$escapeHtml(sublinkData586.subhref) + '"' + ((sublinkData586.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(sublinkData586.subtext) + ((sublinkData586.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
        }
        output += '</ul></li>';
      } else {
        output += '<li><a href="' + soy.$$escapeHtml(linkData569.href) + '" class="item"' + ((linkData569.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData569.text) + ((linkData569.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
      }
    }
  ...
  for (var sectionIndex690 = 0; sectionIndex690 < sectionListLen690; sectionIndex690++) {
    ...
    for (var linkIndex709 = 0; linkIndex709 < linkListLen709; linkIndex709++) {
      ...
      if (linkData709.subLinks != null) {
        output += '<li><a href="' + soy.$$escapeHtml(linkData709.href) + '" class="list-group-item"' + ((linkData709.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData709.text) + ((linkData709.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a><ul class="list-group menu list-unstyled">';
        ...
        for (var sublinkIndex724 = 0; sublinkIndex724 < sublinkListLen724; sublinkIndex724++) {
          ...
          output += '<li><a href="' + soy.$$escapeHtml(sublinkData724.subhref) + '" class="list-group-item"' + ((sublinkData724.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(sublinkData724.subtext) + ((sublinkData724.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
        }
        output += '</ul></li>';
      } else {
        output += '<li><a href="' + soy.$$escapeHtml(linkData709.href) + '" class="list-group-item"' + ((linkData709.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData709.text) + ((linkData709.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
      }
    }
    output += '</ul></section>';
  }
        ...
        if (footerSectionData784.customFooterLinks != null) {
          if (footerSectionIndex784 < 3) {
            ...
            for (var linkIndex796 = 0; linkIndex796 < linkListLen796; linkIndex796++) {
              ...
              output += '<li><a href="' + soy.$$escapeHtml(linkData796.href) + '"' + ((linkData796.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData796.text) + ((linkData796.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
            }
            output += '</ul></section>';
          }
          ...
          for (var linkIndex819 = 0; linkIndex819 < linkListLen819; linkIndex819++) {
            ...
            output += '<li><a href="' + soy.$$escapeHtml(linkData819.href) + '"' + ((linkData819.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData819.text) + ((linkData819.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
          }
          output += '</ul></section>';
        }
      }
        ...
        if (footerSectionData838.customFooterLinks != null) {
          if (footerSectionIndex838 < 3) {
            ...
            for (var linkIndex850 = 0; linkIndex850 < linkListLen850; linkIndex850++) {
              ...
              output += '<li><a href="' + soy.$$escapeHtml(linkData850.href) + '"' + ((linkData850.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData850.text) + ((linkData850.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
            }
            output += '</ul></section>';
          }
          ...
          for (var linkIndex873 = 0; linkIndex873 < linkListLen873; linkIndex873++) {
            ...
            output += '<li><a href="' + soy.$$escapeHtml(linkData873.href) + '"' + ((linkData873.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData873.text) + ((linkData873.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
          }
          output += '</ul></section>';
        }
      }
        ...
        if (footerSectionData892.customFooterLinks != null) {
          if (footerSectionIndex892 < 3) {
            ...
            for (var linkIndex904 = 0; linkIndex904 < linkListLen904; linkIndex904++) {
              ...
              output += '<li><a href="' + soy.$$escapeHtml(linkData904.href) + '"' + ((linkData904.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData904.text) + ((linkData904.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
            }
            output += '</ul></section>';
          }
          ...
          for (var linkIndex927 = 0; linkIndex927 < linkListLen927; linkIndex927++) {
            ...
            output += '<li><a href="' + soy.$$escapeHtml(linkData927.href) + '"' + ((linkData927.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData927.text) + ((linkData927.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
          }
          output += '</ul></section>';
        }
      }
...
wet.builder.splash = function(opt_data, opt_ignored) {
  ...
  var lang__soy1005 = navigator.language;
  output += '<ul class="list-inline lst-spcd"><li>' + ((lang__soy1005 == 'en-CA') ? '<a href="' + soy.$$escapeHtml(opt_data.indexEng) + '" class="btn btn-primary" lang="en">English</a>' : '<a href="' + soy.$$escapeHtml(opt_data.indexEng) + '" class="btn btn-default" lang="en">English</a>') + '</li><li>' + ((lang__soy1005 == 'fr-CA') ? '<a href="' + soy.$$escapeHtml(opt_data.indexFra) + '" class="btn btn-primary" lang="fr">Français</a>' : '<a href="' + soy.$$escapeHtml(opt_data.indexFra) + '" class="btn btn-default" lang="fr">Français</a>') + '</li></ul></row></div><div class="sp-bx-bt col-xs-12"><div class="row"><div class="col-xs-7 col-md-8"><a href="' + soy.$$escapeHtml(opt_data.termsEng) + '" class="sp-lk">Terms & conditions</a> <span class="glyphicon glyphicon-asterisk"></span> <a href="' + soy.$$escapeHtml(opt_data.termsFra) + '" class="sp-lk" lang="fr">Avis</a></div><div class="col-xs-5 col-md-4 text-right mrgn-bttm-md"><img src=\'./gcweb/assets/wmms-spl.svg\' width="127" alt="Symbol of the Government of Canada / Symbole du gouvernement du Canada" /></div></div></div></div></main><!--[if gte IE 9 | !IE ]><!--><script src=\'' + ((opt_data.jqueryEnv == 'external') ? 'https://ajax.googleapis.com/ajax/libs/' : './wet-boew/js/') + 'jquery/2.2.4/jquery.min.js\'><\/script><script src=\'./wet-boew/js/wet-boew.min.js\'><\/script><!--<![endif]--><!--[if lt IE 9]><script src=\'./wet-boew/js/ie8-wet-boew2.min.js\'><\/script><![endif]-->';
  return output;
};
