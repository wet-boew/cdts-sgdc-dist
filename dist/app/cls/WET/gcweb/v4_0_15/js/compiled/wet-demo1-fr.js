// This file was automatically generated from wet-demo1-fr.soy.
...
wet.gcweb.footer = function(opt_data, opt_ignored) {
  ...
  if (opt_data.showFooter != false) {
    ...
    if (opt_data.contactLinks != null) {
      var linkList179 = opt_data.contactLinks;
      var linkListLen179 = linkList179.length;
      if (linkListLen179 > 0) {
        for (var linkIndex179 = 0; linkIndex179 < linkListLen179; linkIndex179++) {
          var linkData179 = linkList179[linkIndex179];
          output += '<li><a href="' + soy.$$escapeHtml(linkData179.href) + '">' + soy.$$escapeHtml(linkData179.text) + '</a></li>';
        }
      } else {
        output += '&nsbp;';
      }
