// This file was automatically generated from wet-demo-en.soy.
...
wet.gcweb.top = function(opt_data, opt_ignored) {
  ...
  if (opt_data.showJumbotron != null) {
    ...
    if (opt_data.showJumbotron != 'default') {
      ...
      output += '<a href="#tab1" title="Tab 1: Increased Universal Child Care Benefit (UCCB)"><img src="/assets/canada/carousel/20150706-1.jpg" alt=""></a></li><li><a href="#tab2" title="Tab 2: Join the Royal Canadian Mounted Police"><img src="/assets/canada/carousel/20150720-2.jpg" alt=""></a></li><li><a href="#tab3" title="Tab 3: PM announces conclusion of Free Trade Agreement with Ukraine"><img src="/assets/canada/carousel/20150714-3.jpg" alt=""></a></li><li><a href="#tab4" title="Tab 4: Planning a trip this summer? Remember to pack travel insurance."><img src="/assets/canada/carousel/20150720-1.jpg" alt=""></a></li></ul><div class="tabpanels"><div role="tabpanel" id="tab1" class="in fade"><a href="canada.ca/en/campaign/taxsavings/index.html" class="learnmore"><figure><img src="' + soy.$$escapeHtml(opt_data.templateDomain) + '/app/cls/WET/gcweb/v4_0_15/img/promos/20150706-1.jpg" alt=""><figcaption><p>Increased Universal Child Care Benefit (<abbr>UCCB</abbr>)</p></figcaption></figure></a></div><div role="tabpanel" id="tab2" class="out fade"><a href="http://www.rcmp-grc.gc.ca/recruiting-recrutement/rm-mr/rm-mr-eng.htm?utm_source=Canada.ca&amp;utm_medium=carousel&amp;utm_campaign=RCMP_Recruitment" class="learnmore"><figure><img src="' + soy.$$escapeHtml(opt_data.templateDomain) + '/app/cls/WET/gcweb/v4_0_15/img/promos/20150720-2.jpg" alt=""><figcaption><p>Join the Royal Canadian Mounted Police</p></figcaption></figure></a></div><div role="tabpanel" id="tab3" class="out fade"><a href="http://pm.gc.ca/eng/news/2015/07/14/pm-announces-conclusion-free-trade-agreement-ukraine" class="learnmore"><figure><img src="' + soy.$$escapeHtml(opt_data.templateDomain) + '/app/cls/WET/gcweb/v4_0_15/img/promos/20150714-3.jpg" alt=""><figcaption><p><abbr title="Prime Minister">PM</abbr> announces conclusion of Free Trade Agreement with Ukraine</p></figcaption></figure></a></div><div role="tabpanel" id="tab4" class="out fade"><a href="http://travel.gc.ca/travelling/documents/travel-insurance?campaign=2015-travelinsurance-cdnsitecarousel" class="learnmore"><figure><img src="' + soy.$$escapeHtml(opt_data.templateDomain) + '/app/cls/WET/gcweb/v4_0_15/img/promos/20150720-1.jpg" alt=""><figcaption><p>Planning a trip this summer? Remember to pack travel insurance.</p></figcaption></figure></a></div>';
    }
