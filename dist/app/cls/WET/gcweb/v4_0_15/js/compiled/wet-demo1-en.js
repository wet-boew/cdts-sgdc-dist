// This file was automatically generated from wet-demo1-en.soy.
...
wet.gcweb.top = function(opt_data, opt_ignored) {
  ...
  output += (opt_data.showPreContent != false) ? '<aside class="prm-sngl"><div class="container"><div class="row"><h2 class="wb-inv">Promotions</h2><img src="' + soy.$$escapeHtml(opt_data.templateDomain) + '/app/cls/WET/gcweb/v4_0_15/img/promos/ndoh.jpg" class="img-responsive" alt="National day of honour Afghanistan - May 9, 2014" /></div></div></aside>' : '';
  return output;
};
