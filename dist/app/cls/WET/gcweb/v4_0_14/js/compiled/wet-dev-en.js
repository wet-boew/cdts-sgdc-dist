...
wet.gcweb.preFooter = function(opt_data, opt_ignored) {
  var output = ((opt_data.showPostContent != false) ? '<aside class="prm-sngl"><div class="container"><div class="row"><h2 class="wb-inv">Promotions</h2><img src="' + soy.$$escapeHtml(opt_data.templateDomain) + '/app/cls/WET/gcweb/v4_0_14/img/promos/1170x347-2.png" class="img-responsive" alt="Place holder image." /></div></div></aside>' : '') + '<div class="row pagedetails"><div class="col-sm-5 col-xs-12 datemod"><dl id="wb-dtmd"><dt>Date modified:&#32;</dt><dd><time property="dateModified">' + soy.$$escapeHtml(opt_data.dateModified) + '</time></dd></dl></div>' + ((opt_data.showFeedback != false) ? '<div class="clear visible-xs"></div><div class="col-sm-4 col-xs-6">' + ((opt_data.showFeedback != null) ? '<a href="' + soy.$$escapeHtml(opt_data.showFeedback) + '" class="btn btn-default"><span class="glyphicon glyphicon-comment mrgn-rght-sm"></span>Feedback<span class="wb-inv"> about this web site</span></a>' : '<a href="http://www.canada.ca/en/contact/feedback.html" class="btn btn-default"><span class="glyphicon glyphicon-comment mrgn-rght-sm"></span>Feedback<span class="wb-inv"> about this web site</span></a>') + '</div>' : '');
  if (opt_data.showShare != false) {
    output += '<div class="col-sm-3 col-xs-6 text-right">';
    if (opt_data.showShare != null) {
      output += '<!--Works--><div class="wb-share" data-wb-share=\'{"lnkClass": "btn btn-default"}\'></div><!--Works--><div class="wb-share" data-wb-share=\'{"lnkClass": "btn btn-default"}\'></div><!--Not working--><div class="wb-share" data-wb-share=\'{"filter": [';
